...
class TeachingServiceTests {
    ...
    async runTests(RetrievedValues, module_descriptor, serviceIndex) {
		...
		winston.debug({message: '==========================================================='});
		winston.info({message:  '----------------- Teaching Service tests ------------------'});
		winston.debug({message: '==========================================================='});
		winston.debug({message: ' '});
		
		// Teaching service - Type 4
        ...
        winston.info({message: 'MERGLCB: ==== Teaching Service Test run finished \n'});
		
//		winston.debug({message: 'MERGLCB: TS : RetrievedValues.data ' + JSON.stringify(RetrievedValues.data, null, "    ")});
