...
class DCC_CMD_ServiceTests {
    ...
    async runTests(RetrievedValues, module_descriptor, serviceIndex) {
		...
		winston.debug({message: '==========================================================='});
		winston.info({message:  '----------------- DCC_CMD Service tests -------------------'});
		winston.debug({message: '==========================================================='});
		winston.debug({message: ' '});
		
		// DCC_CMD service - Type 14
...
*/
        ...
        winston.info({message: 'MERGLCB: ==== DCC_CMD Service Test run finished \n'});
...
module.exports = {
    DCC_CMD_ServiceTests: DCC_CMD_ServiceTests
}