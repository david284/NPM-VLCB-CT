...
class EventAcknowledgeServiceTests {
    ...
    async runTests(RetrievedValues, module_descriptor, serviceIndex) {
		...
		winston.debug({message: '==========================================================='});
		winston.info({message:  '------------ Event Acknowledge Service tests --------------'});
		winston.debug({message: '==========================================================='});
		winston.debug({message: ' '});
		
		// Event Acknowledge service - Type 9
...
/*				No diagnostics defined for this service
...
*/
        ...
        winston.info({message: 'MERGLCB: ==== Event Acknowledge Service Test run finished \n'});
...
module.exports = {
    EventAcknowledgeServiceTests: EventAcknowledgeServiceTests
}