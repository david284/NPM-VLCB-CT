...
class LongMessageServiceTests {
    ...
    async runTests(RetrievedValues, module_descriptor, serviceIndex) {
		...
		winston.debug({message: '==========================================================='});
		winston.info({message:  '--------------- LongMessage Service tests -----------------'});
		winston.debug({message: '==========================================================='});
		winston.debug({message: ' '});
		
		// LongMessage service - Type 14
...
*/
        ...
        winston.info({message: 'MERGLCB: ==== LongMessage Service Test run finished \n'});
...
module.exports = {
    LongMessageServiceTests: LongMessageServiceTests
}