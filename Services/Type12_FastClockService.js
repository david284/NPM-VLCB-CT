...
class FastClockServiceTests {
    ...
    async runTests(RetrievedValues, module_descriptor, serviceIndex) {
		...
		winston.debug({message: '==========================================================='});
		winston.info({message:  '---------------- FastClock Service tests ------------------'});
		winston.debug({message: '==========================================================='});
		winston.debug({message: ' '});
		
		// FastClock service - Type 12
...
*/
        ...
        winston.info({message: 'MERGLCB: ==== FastClock Service Test run finished \n'});
...
module.exports = {
    FastClockServiceTests: FastClockServiceTests
}