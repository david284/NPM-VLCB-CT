...
module.exports = class opcodes_Bx {
  ...
  async test_REQEV(RetrievedValues, eventIdentifier, eventVariableIndex) {
  ...
  //
  // Format: [<MjPri><MinPri=3><CANID>]<B2><NN hi><NN lo><EN hi><EN lo><EV# >
  async test_REQEV_INVALID_EVENT(RetrievedValues, eventIdentifier, eventVariableIndex) {
	...
	// 0xB2 - REQEV_INVALID_INDEX
  // Format: [<MjPri><MinPri=3><CANID>]<B2><NN hi><NN lo><EN hi><EN lo><EV# >
  async test_REQEV_INVALID_INDEX(RetrievedValues, eventIdentifier, eventVariableIndex) {
	...
	// 0xB2 - REQEV_SHORT
  // Format: [<MjPri><MinPri=3><CANID>]<B2><NN hi><NN lo><EN hi><EN lo><EV# >
  async test_REQEV_SHORT(RetrievedValues, eventIdentifier, eventVariableIndex) {
