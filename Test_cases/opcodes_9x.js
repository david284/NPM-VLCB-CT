...
module.exports = class opcodes_9x {
  ...
  async test_AREQ(RetrievedValues, nodeNumber, eventNumber) {
  ...
  async test_EVULN(RetrievedValues,eventIdentifier) {
	...
	// 0x95 - EVULN_INVALID_EVENT
  // Format: [<MjPri><MinPri=3><CANID>]<95><NN hi><NN lo><EN hi><EN lo>
  async test_EVULN_INVALID_EVENT(RetrievedValues,eventIdentifier) {
	...
	// 0x95 - EVULN_SHORT
  // Format: [<MjPri><MinPri=3><CANID>]<95><NN hi><NN lo><EN hi><EN lo>
  async test_EVULN_SHORT(RetrievedValues,eventIdentifier) {
  ...
  async test_NVSET(RetrievedValues, nodeVariableIndex, nodeVariableValue) {
	...
	// 0x96 - NVSET_INVALID_INDEX
  // Format:  [<MjPri><MinPri=3><CANID>]<96><NN hi><NN lo><NV# ><NV val>
  async test_NVSET_INVALID_INDEX(RetrievedValues, nodeVariableIndex, nodeVariableValue) {
	...
	// 0x96 - NVSET_SHORT
  // Format:  [<MjPri><MinPri=3><CANID>]<96><NN hi><NN lo><NV# ><NV val>
  async test_NVSET_SHORT(RetrievedValues, nodeVariableIndex, nodeVariableValue) {
  ...
  async test_ASRQ(RetrievedValues, nodeNumber, eventNumber) {
